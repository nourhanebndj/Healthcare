            ...
            <div class="p-6 pt-10 pl-8 w-full">
                <div class="bg-white overflow-hidden shadow-lg rounded-lg mb-8 w-full">
                    <div class="p-6 bg-[#2563eb] text-black">
                        <h2 class="text-2xl font-bold">Welcome to Admin Dashboard, <?php echo e(Auth::user()->name); ?>!</h2>
...
</html><?php /**PATH C:\Users\nourh\Downloads\Bureau\Master1\Semestre 2\BDD NoSQL\mini projet\monitoring_patient\monitoring_patient\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>