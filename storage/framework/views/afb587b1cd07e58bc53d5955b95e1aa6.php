            ...
            <div class="p-6 pt-10 pl-8 w-full">
                <div class="bg-white overflow-hidden shadow-lg rounded-lg mb-8 w-full">
                    <div class="p-6 bg-[#2563eb] text-black">
                        <h2 class="text-2xl  font-bold">Welcome Dr. <?php echo e(Auth::user()->name); ?>!</h2>
                        <p class="mt-2">Manage your patients and medical data efficiently.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg">
                        <h3 class="text-gray-500">Anomalies Detected</h3>
                ...
                <div class="mt-10 grid grid-cols-1 gap-6 w-full">
                    <div class="bg-white p-6 rounded-2xl shadow-lg">
                        <h3 class="text-gray-500">Patient Analytics</h3>
                        <div class="h-32 bg-[#f2f4ea] mt-4 rounded"></div>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-lg">
                        <h3 class="text-gray-500">Medical Reports</h3>
                        <div class="h-32 bg-[#f2f4ea] mt-4 rounded"></div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\nourh\Downloads\Bureau\Master1\Semestre 2\BDD NoSQL\mini projet\monitoring_patient\monitoring_patient\resources\views/dashboard.blade.php ENDPATH**/ ?>