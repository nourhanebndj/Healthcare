                ...
                <div class="bg-white shadow rounded-lg overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $speciality->created_at }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $speciality->name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <!-- Bouton Modifier -->
                                    <button
                                        @click="editModalOpen = true; selectedSpeciality = { id: {{ $speciality->id }}, name: '{{ $speciality->name }}' }"
                                    ...
                                    <!-- Bouton Supprimer -->
                                    <form action="{{ route('specialities.destroy', $speciality->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="submit"
